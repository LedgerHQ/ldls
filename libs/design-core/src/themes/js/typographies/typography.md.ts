...
export const typographyMdTokens = {
  responsiveDisplay: {
    '1': {
      size: primitiveTypographyTokens.fontSize['112'],
      weight: primitiveTypographyTokens.fontWeight.bold,
      lineHeight: primitiveTypographyTokens.fontLineHeight['112'],
      letterSpacing: primitiveTypographyTokens.fontLetterSpacing['112'],
    },
    '2': {
  ...
  heading: {
    ...
    '2': {
      ...
      size2: primitiveTypographyTokens.fontSize['32'],
      weightSemiBold: primitiveTypographyTokens.fontWeight.semiBold,
      weightMedium: primitiveTypographyTokens.fontWeight.medium,
  ...
  grid: {
    columnCount: 12,
    gutter: primitiveLayoutTokens.spacing['40'],
  },
