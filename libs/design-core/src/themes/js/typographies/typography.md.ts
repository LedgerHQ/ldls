...
export const typographyOtherTokens = {
  responsiveDisplay: {
    '1': {
      size: primitiveTokens.fontSize['112'],
      weight: primitiveTokens.fontWeight.bold,
      lineHeight: primitiveTokens.fontLineHeight['112'],
      letterSpacing: primitiveTokens.fontLetterSpacing['112'],
    },
    '2': {
  ...
  heading: {
    ...
    '2': {
      ...
      size2: primitiveTokens.fontSize['32'],
      weightSemiBold: primitiveTokens.fontWeight.semiBold,
      weightMedium: primitiveTokens.fontWeight.medium,
  ...
  grid: {
    columnCount: 12,
    gutter: primitiveTokens.spacing['40'],
  },
