...
export const tokens: Record<string, Record<string, string | number>> = {
  ':root': {
    ...
    '--font-style-display-1-letter-spacing': 'var(--font-letter-spacing-64)',
    ...
    '--font-style-display-2-letter-spacing': 'var(--font-letter-spacing-40)',
    ...
    '--font-style-heading-2-size': 'var(--font-size-22)',
