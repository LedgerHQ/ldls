...
export const tokens: Record<string, Record<string, string>> = {
  '.dark': {
    ...
    '--color-background-error': 'var(--color-dark-red-600-20)',
    ...
    '--color-background-warning': 'var(--color-dark-yellow-600-20)',
    '--color-background-warning-strong': 'var(--color-dark-yellow-600)',
    '--color-background-success': 'var(--color-dark-green-600-20)',
    ...
    '--background-gradient-on-accent-100':
      'var(--color-background-gradient-on-accent-enterprise-100)',
    '--background-gradient-on-accent-0':
      'var(--color-background-gradient-on-accent-enterprise-0)',
