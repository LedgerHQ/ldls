...
const cryptoTextColors = getCryptoColors(websitesTheme, '--color-crypto');
const cryptoBackgroundColors = getCryptoColors(websitesTheme, '--color-crypto');

export const customPlugin = plugin(
  function ({ addBase }) {
    addBase(websitesTheme);
  },
  {
    theme: {
      backgroundColor: {
        ...
        'transparent-muted-pressed':
          'var(--background-transparent-muted-pressed)',
        'transparent-muted-disabled':
          'var(--background-transparent-muted-disabled)',
