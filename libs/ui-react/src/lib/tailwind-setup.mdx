...
2. **Prettier Plugin Tailwind** ([prettier-plugin-tailwindcss](https://github.com/tailwindlabs/prettier-plugin-tailwindcss))
   ...
   - Install with:
     ...
     ```
   - Add to your prettier settings (in your `.prettierrc.json` file):
     ```json
     {
...
3. **ESLint Plugin Tailwind** ([eslint-plugin-tailwindcss](https://github.com/tailwindlabs/eslint-plugin-tailwindcss))
...
[class-variance-authority](https://www.npmjs.com/package/class-variance-authority) provides:
