...
When disabled, tiles become non-interactive and display with reduced opacity.
...
Horizontal lists are used to display a list of tiles in a horizontal scrollable container. In horizontal lists, you can remove rounded corners on the sides to create a seamless connected appearance.
