...
**These tokens are used under the hood as CSS variables** by the `@ledgerhq/ldls-design-core` library (e.g., `var(--color-light-purple-050)`) and **should not be used directly by developers**. They serve as the foundation for semantic tokens.
