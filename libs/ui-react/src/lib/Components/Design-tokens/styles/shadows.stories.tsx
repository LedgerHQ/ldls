...
const meta: Meta = {
  title: 'Foundations/Design Tokens/Styles/Shadows',
};
  ...
  <div className="mb-32">
    <div className="grid grid-cols-1 gap-16 gap-y-40 sm:grid-cols-2 lg:grid-cols-3">
      {[
        ...
        <div key={name}>
          <div className="border flex h-192 w-192 items-center justify-center rounded-lg border-1 border-muted-subtle text-center dark:bg-muted-on-muted">
