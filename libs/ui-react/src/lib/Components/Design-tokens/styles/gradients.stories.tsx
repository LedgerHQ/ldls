...
const GradientShowcase = () => (
  <div className='mb-32'>
    <div className='space-y-32'>
      <div>
        <h4 className='mb-16 heading-4 text-base'>Directional Gradients</h4>
      ...
      <div>
        <h4 className='mb-16 heading-4 text-base'>Status Gradients</h4>
      ...
      <div>
        <h4 className='mb-16 heading-4 text-base'>Asset Gradients</h4>
