...
export const DefaultTailwindAnimations: Story = {
  render: () => (
    <>
      <h2 className='mt-32 mb-16 text-start heading-2'>Static animation</h2>
...
export const AllAnimations: Story = {
  render: () => (
    <div className='space-y-48'>
      ...
      <div>
        <h2 className='mt-32 mb-16 text-start heading-2'>Fade</h2>
        <div className='rounded-2xl border border-muted-subtle bg-canvas p-16'>
      ...
      <div>
        <h2 className='mt-32 mb-16 text-start heading-2'>Slide in</h2>
      ...
      <div>
        <h2 className='mt-32 mb-16 text-start heading-2'>Slide out</h2>
        <div className='rounded-2xl border border-muted-subtle bg-canvas p-8'>
          <div className='grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4'>
            <AnimationDemo
              animationClass='animate-slide-out-to-top'
