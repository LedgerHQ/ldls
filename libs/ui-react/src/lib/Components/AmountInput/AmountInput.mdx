...
AmountInput is a specialized input component designed for handling numeric values with fiat currency display. It features configurable fiat text positioning, error states, and proper numeric input handling.
...
The fiat text can be positioned on either the left (default) or right side of the input:

<Canvas of={AmountInputStories.Default} />
<Canvas of={AmountInputStories.WithRightFiat} />
