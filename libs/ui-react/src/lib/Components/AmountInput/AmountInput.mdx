...
```
  ...
  <DoVsDontRow>
    <DoBlockItem
      title='Use container for width control'
      description='Control width using wrapper containers with responsive design'
    >
...
```
    ...
    <DontBlockItem
      ...
      description='Core styling, padding, typography, and states should not be modified'
    >

{/* prettier-ignore */}
```tsx
<AmountInput className='bg-white border-accent' />
```
