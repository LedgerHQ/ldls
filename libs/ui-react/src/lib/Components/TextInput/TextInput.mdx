...
<div className='flex flex-col gap-24'>
  <DoVsDontRow>
    <DoBlockItem
      ...
      description='When you want to hide the clear button, use the hideClearButton prop. The clear button appears automatically when input has content; use onClear to extend behavior'
    >
...
```
    ...
    <DontBlockItem
      title="Don't use empty prefix or create custom clear buttons"
      description='Prefix is not available on TextInput component. Dont try to use empty prefix to hide the clear button - use hideClearButton instead. Also avoid creating custom clear buttons'
    >

{/* prettier-ignore */}
```tsx
// DON'T - prefix is not available on TextInput
<TextInput
  prefix={null} // This will cause a TypeScript error
  value={value}
  onChange={handleChange}
/>

// DON'T - create custom clear buttons
<TextInput
  value={value}
  onChange={handleChange}
...
```
  ...
  <DoVsDontRow>
    <DoBlockItem
      title='Use className for container styling'
      description='Use className to style the container element (including error message area) for layout, spacing, and responsive design'
    >
...
```
    ...
    <DontBlockItem
      title="Don't use inputClassName or labelClassName"
      description='These props are not available on TextInput. Use className for container-level styling only'
    >

{/* prettier-ignore */}
```tsx
// These props don't exist on TextInput
<TextInput 
...
```
  ...
  <DoVsDontRow>
    <DoBlockItem
      ...
      description='Use tree-shaking to import specific icons for better bundle size'
    >
...
<TextInput 
  suffix={<InformationFill size={20}/>}
/>
```
    ...
    <DontBlockItem
      ...
      description='Avoid importing all icons or creating complex elements inline'
    >
...
<TextInput 
  suffix={<Icons.InformationFill size={20}/>}
/>
```
