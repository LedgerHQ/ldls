...
<div className='flex flex-col gap-24'>
  <DoVsDontRow>
    <DoBlockItem
      ...
      description='Use tree-shaking for better bundle size'
    >
...
```
    ...
    <DontBlockItem
      ...
      description='Avoid importing entire library or dynamic icon selection'
    >
...
```
  ...
  <DoVsDontRow>
    <DoBlockItem
      ...
      description='Color, positioning, spacing, and responsive behavior are allowed'
    >
...
```
    ...
    <DontBlockItem
      title="Don't override core properties"
      description='Core dimensions, stroke, arbitrary colors, or SVG props should not be modified'
    >
...
```
  ...
  <DoVsDontRow>
    <DoBlockItem
      title='Use semantic wrappers for interaction'
...
```
    ...
    <DontBlockItem
      title="Don't make icons directly clickable"
      description='Avoid arbitrary colors or overriding currentColor unnecessarily'
    >
