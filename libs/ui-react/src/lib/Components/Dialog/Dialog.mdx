...
<div className='rounded-8 mt-8 p-12 text-base'>
  ...
  <ul className='space-y-2 body-2'>
    ...
    <li>
      In most cases, wrap your main content in DialogBody to ensure proper
      spacing and layout. For simple informational layouts, you may omit
      DialogBody if the layout works as intended.
    </li>
