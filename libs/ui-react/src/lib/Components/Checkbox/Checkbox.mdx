...
```bash
npm install @ledgerhq/ldls-ui-react @radix-ui/react-checkbox
```
...
<div className='flex flex-col gap-24'>
  <DoVsDontRow>
    <DoBlockItem
      ...
      description='Responsive behavior, margins, and positioning are allowed'
    >
...
```
    ...
    <DontBlockItem
      ...
      description='Core styling, size, appearance, and spacing should not be modified'
    >
