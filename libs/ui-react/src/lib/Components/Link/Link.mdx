...
```
  ...
  <DoVsDontRow>
    <DoBlockItem
      ...
      description='Layout positioning, margins, and responsive behavior are allowed'
    >
...
```
    ...
    <DontBlockItem
      ...
      description='Core styling, spacing, typography, and states should not be modified'
    >
...
```
  ...
  <DoVsDontRow>
    <DoBlockItem
      ...
      description='Let Link handle icon sizing automatically'
    >
...
```
    ...
    <DontBlockItem
      ...
      description='Avoid importing entire icon library or modifying icon size directly'
    >
