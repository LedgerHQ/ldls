...
import * as TileItemStories from './TileItem.stories';
import { TileItem } from './TileItem';
import { CustomTabs, Tab } from '../../../../.storybook/CustomTabs';

<Meta title='Containment/TileItem' of={TileItemStories} />
...
TileItem components are compact, card-like interactive elements designed for horizontal lists, carousels, or grids. They feature a vertical layout with a required spot icon and title, as well as an optional subtitle, tag, and a secondary action button visible on hover.

> View in [Figma](https://www.figma.com/design/JxaLVMTWirCpU0rsbZ30k7/2.-Components-Library?node-id=5783-1328).

## Anatomy

<Canvas of={TileItemStories.Base} />
...
<Canvas of={TileItemStories.Base} />
<Controls of={TileItemStories.Base} />

### Spot Variants

TileItem components support various spot icons to categorize or visualize the content, including coin icons.

<Canvas of={TileItemStories.SpotVariantsShowcase} />

### Tag Variants

Optional tags can be added at the bottom with different appearances.

<Canvas of={TileItemStories.WithTag} />

### Without Secondary Action

The secondary action is optional and can be omitted.

<Canvas of={TileItemStories.WithoutSecondaryAction} />

### Carousel Variant

In carousel mode, only the first and last items have rounded corners on their respective sides.

<Canvas of={TileItemStories.List} />

## Responsive Layout

TileItem components adapt to their container width, truncating long titles and subtitles as needed.
...
To use the TileItem component with our custom Tailwind preset, you need to configure your `tailwind.config.ts`:
