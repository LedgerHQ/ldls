...
The AddressFieldInput component provides a specialized input field for entering cryptocurrency addresses or ENS names. Built on top of BaseInput, it features a fixed "To:" prefix label and context-aware suffix icons.
...
- **Fixed "To:" prefix** - Immediately identifies the input's purpose
