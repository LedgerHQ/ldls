...
<SelectItem value='option1'>
  <SelectItemText>
    ...
    {/* Don't nest description inside SelectItemText */}
  </SelectItemText>
</SelectItem>
```
...
```tsx
<SelectItem value='option1'>
  Option Title {/* Don't use raw text - always wrap with SelectItemText */}
</SelectItem>
```
...
> **Note:** `SelectScrollUpButton` and `SelectScrollDownButton` are automatically rendered inside `SelectContent`. You don't need to manually add them unless you want custom styling.
