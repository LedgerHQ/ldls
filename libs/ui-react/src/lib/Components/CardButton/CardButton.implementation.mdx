...
Use the `caret` prop to show a chevron indicating navigation:
...
<CardButton
  ...
  className="bg-black text-white" // Override core colors
/>
...
<CardButton
  ...
  className="gap-8 p-6" // Override internal spacing
/>
...
<CardButton
  ...
  className="heading-2" // Override typography
/>
...
import { Settings, CreditCard, Shield } from '@ldls/ui-react/symbols';
