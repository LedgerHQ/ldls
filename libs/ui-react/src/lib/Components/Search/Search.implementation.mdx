...
The Search component takes the **full width** of its parent container by default. To control the width, wrap it in a container with the desired width constraints:
