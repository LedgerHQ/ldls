...
The Search component takes the **full width** of its parent container by default. You can control the width using `containerClassName` (preferred) or wrapper containers:

```tsx
// ✅ Preferred: Direct width control
<Search placeholder="Search..." containerClassName="max-w-md" />

// ✅ Responsive width control
<Search placeholder="Search..." containerClassName="w-full md:max-w-md" />
...
<Search placeholder="Search..." containerClassName="w-full md:max-w-lg" />
