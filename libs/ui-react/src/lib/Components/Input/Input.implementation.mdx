...
The Input component takes the **full width** of its parent container by default. To control the width, use wrapper containers:

```tsx
// With width constraint container
