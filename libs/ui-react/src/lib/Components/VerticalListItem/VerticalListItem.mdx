...
- **Secondary Button (optional)**: Action button in the top right corner, visible on hover
...
The secondary button is optional and can be omitted.

<Canvas of={VerticalListItemStories.WithoutSecondaryButton} />
...
> - Spot and secondary button maintain fixed sizes
