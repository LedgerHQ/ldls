...
```tsx
import { Spot } from '@ldls/ui-react';
import { Settings, Heart, Star } from '@ldls/ui-react/symbols';
...
import { Settings, Heart } from '@ldls/ui-react/symbols';
...
import { Settings, Bluetooth } from '@ldls/ui-react/symbols';
```
...
import * as AllSymbols from '@ldls/ui-react/symbols';
```
