 ...
 * import { ShieldLock } from '@ledgerhq/ldls-ui-rnative/symbols';
 * 
 * <ShieldLock />
 * 
 * @example
 ...
 */
;
export const ShieldLock = createIcon("ShieldLock", <Svg width={24} height={24} fill="currentColor" viewBox="0 0 16 16"><Path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.3} d="M9.018 7.417v-.9c0-.562-.46-1.02-1.02-1.02-.562 0-1.02.453-1.02 1.013v.893m2.189.01H6.833a.66.66 0 0 0-.666.667v1.413c0 .367.293.667.666.667h2.334c.366 0 .666-.3.666-.667v-1.42c0-.373-.3-.666-.666-.666zm4.166.08c0 2.912-2.104 5.64-4.986 6.454-.227.06-.468.06-.694 0-2.886-.82-4.986-3.547-4.986-6.46V4.8c0-.547.326-1.033.826-1.234l3.24-1.327a3.3 3.3 0 0 1 2.52 0l3.24 1.327c.5.2.827.687.827 1.234v2.685z" /></Svg>);