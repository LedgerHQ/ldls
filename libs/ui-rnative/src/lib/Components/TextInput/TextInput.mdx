...
<TextInput
  ...
  containerClassName='max-w-md' // Control width
...
<TextInput label="Email" containerClassName="max-w-md" />

// Responsive width control
<TextInput label="Email" containerClassName="w-full md:max-w-md" />

// Use className for input-specific styling
<TextInput className="heading-0" label="Title" />

// Use containerClassName for margins and positioning
<TextInput label="Email" containerClassName="mt-4 mx-auto" />
...
<TextInput className="bg-white border-gray-300" label="Email" />

// Don't modify internal padding/spacing
<TextInput className="px-6 py-4" label="Email" />

// Don't override typography
<TextInput className="body-4" label="Email" />

// Don't modify focus/error states
<TextInput className="border-error" label="Email" />
```
