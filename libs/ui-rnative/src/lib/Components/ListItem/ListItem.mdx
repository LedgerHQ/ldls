...
- Native touch feedback with `TouchableOpacity`
...
To use the ListItem component with our custom NativeWind preset, you need to configure your `tailwind.config.ts`:
...
Make sure to configure NativeWind in your `metro.config.js` and import the CSS file as per NativeWind documentation.
...
import { Settings, PenEdit, ChevronRight, User } from '@ledgerhq/ldls-ui-rnative/symbols';
