...
<div className='flex flex-col gap-24'>
  <DoVsDontRow>
    <DoBlockItem
      title='Use in ScrollView with proper grouping'
      description='ListItems work best when grouped in ScrollView containers for list contexts'
    >

{/* prettier-ignore */}
```tsx
<ScrollView className='max-w-320'>
...
```
    ...
    <DontBlockItem
      title="Don't use for non-list contexts"
      description='Avoid using ListItem as standalone elements with custom borders or margins'
    >
...
<ScrollView className='max-w-320'>
  ...
  <ListItem title='Another' className='m-4 border' onPress={() => {}} />
</ScrollView>
```
