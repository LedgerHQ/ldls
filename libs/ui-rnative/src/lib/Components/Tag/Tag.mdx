...
npm install react-native@^0.74.0 react@^18.3.1 nativewind@^4.0.0 tailwindcss@^3.4.0 class-variance-authority
```

### NativeWind Configuration

To use the Tag component with our custom NativeWind preset, you need to configure your `tailwind.config.ts`:
...
<Tag className="text-xl" label="Wrong Typography" />
```
...
<Tag onClick={handleClick} label="Wrong Event" />
