...
1. **ThemeProvider** – Wrap your entire app and register theme and shared components context.
2. **GlobalTooltipBottomSheet** – Instance of the bottom sheet component that will be used to display the tooltip content.
...
```tsx
// Include GlobalTooltipBottomSheet once at root level
function App() {
  return (
    <ThemeProvider>
      <Navigation />
