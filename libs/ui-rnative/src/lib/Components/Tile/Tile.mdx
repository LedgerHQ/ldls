...
<div className='flex flex-col gap-24'>
  <DoVsDontRow>
    <DoBlockItem
      ...
      description='Wrap Tile in container elements to control its width'
    >
...
```
    ...
    <DontBlockItem
      title="Don't use className for width control"
      description='Avoid using className to set width directly on Tile'
    >
