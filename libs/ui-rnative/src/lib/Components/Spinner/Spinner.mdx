...
const config = {
  content: [
    ...
    './node_modules/@ledgerhq/lumen-ui-rnative/src/**/*.{js,ts,jsx,tsx}', // Ledger UI Kit components
  ],
...
```
    ...
    <DontBlockItem
      ...
      description='Avoid using className or additional props to override spinner dimensions'
    >

{/* prettier-ignore */}
```tsx
// Small inline loading
<Spinner size={12} className='w-6 h-6' />
