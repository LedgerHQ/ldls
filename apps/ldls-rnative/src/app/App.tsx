...
import { View, Text, SafeAreaView, Linking, ScrollView, TouchableOpacity } from 'react-native';
//import { styled } from 'nativewind';
import Svg, { G, Path } from 'react-native-svg/lib/typescript/elements';
...
export const App = () => {
  return null //(
    ...
    //     <StyledText className="text-3xl font-bold text-gray-900 mb-4">LDLS React Native</StyledText>
    //     <StyledText className="text-base text-gray-600 text-center">
    //       Welcome to the React Native implementation of the Ledger Design System
    //     </StyledText>
    //   </StyledView>
    // </StyledSafeAreaView>
    //   <SafeAreaView
    ...
    //               ]}
    //             >
    //               nx run-many -p LdlsRnative -t build test lint
    //             </Text>
    //           </View>
